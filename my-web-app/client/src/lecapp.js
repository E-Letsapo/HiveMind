...
class LecApp extends Component {
  ...
  insertData = () => {
    ...
    // Only allow insert operation if the university name is LEC
    if (newData.university_name === 'LEC') {
      ...
      window.alert('University name must be "LEC" for insert operation');
    }
  };
  ...
  render() {
    ...
    const filteredData = data.filter((row) => row.university_name === 'LEC');
