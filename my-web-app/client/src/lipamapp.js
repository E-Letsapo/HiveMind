...
class LipamApp extends Component {
  ...
  insertData = () => {
    ...
    // Only allow insert operation if the university name is LIPAM
    if (newData.university_name === 'LIPAM') {
      ...
      window.alert('University name must be "LIPAM" for insert operation');
    }
  };
  ...
  render() {
    ...
    const filteredData = data.filter((row) => row.university_name === 'LIPAM');
